...
export const metadata = {
  ...
  description:
    "Hand-picked deals on electronics, fashion, kitchen & more. Verified discounts on Amazon & Flipkart.",
};
  ...
  return (
    <>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 page-enter">
        ...
        <section
          className="mb-12 rounded-2xl bg-accent p-8 sm:p-12 text-white text-center
