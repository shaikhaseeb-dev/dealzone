    ...
    <div className="page-enter">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="card p-5">
          ...
          <div className="space-y-3">
            {(safeStats.categoryBreakdown || []).map((cat) => (
            ...
            <thead>
              <tr className="border-b border-[var(--border)]">
                {[
                  ...
                  <th
                    key={h}
                    className="text-left pb-3 text-xs font-semibold text-[var(--text-muted)] px-2 first:pl-0"
                  >
                    {h}
                  </th>
                ))}
            ...
            <tbody>
              {(products || []).slice(0, 6).map((p) => (
                ...
                >
                  ...
                  <td className="py-3 px-2">
                    <span
                      className={`badge ${p.inStock ? "bg-green-500/10 text-green-500" : "bg-red-500/10 text-red-500"}`}
                    >
