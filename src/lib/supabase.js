...
export async function getProducts(filters = {}) {
  ...
  let query = supabase
    .from("products")
    .select("*")
    // Remove the .eq('active', true) line OR make it conditional
    .order("created_at", { ascending: false });

  // If you want to keep the active filter, check your database:
  // Your 2 products MUST have active = true in Supabase
